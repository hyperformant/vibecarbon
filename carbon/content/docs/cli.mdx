...
npx vibecarbon configure globalization
```
...
```bash
npx vibecarbon configure cicd          # stage 1 only
npx vibecarbon configure cicd prod     # stage 1, plus stage 2 if prod is k8s
```
