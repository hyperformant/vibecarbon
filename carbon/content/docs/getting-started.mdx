...
If you're deploying single-server Docker Compose, skip straight to `deploy`; no license needed. Kubernetes and Kubernetes HA need a subscription key; activate it first:
