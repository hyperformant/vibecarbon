...
- **Quality gates apply.** When you go idle, a hook runs `npm run lint`, `npm run typecheck`, and `npm run test:security`. Fix any errors before considering your work done.
